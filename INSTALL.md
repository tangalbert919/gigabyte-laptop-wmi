...
**Note:** save this as for example gigabyte-laptop-wmi.nix and call it in your configuration using boot.extraModulePackages = [ (config.boot.kernelPackages.callPackage ./gigabyte-laptop-wmi.nix {}) ];
